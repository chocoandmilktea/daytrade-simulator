...
- 急ぎの課題はない。PR #50・#51・#52（daytrade-simulator）と PR #18（tachibana-server）は
  いずれもマージ済み
...
1. Phase 2B（ギャップ予測を気配ベースへ）。158件のデータ蓄積が始まったところ
2. PR2 の着手判断。429 が再発するか、表示銘柄数が大きく増えた時点で再評価
3. parts.ranking の修正着手判断。組み立ての予算超過が観測された時点で再評価
...
- ENV_CHANGELOG.md の記録範囲は決着済み。CLAUDE.md など通常のドキュメント変更は
  ...
  8/25 の PR#48、8/26 の CLAUDE.md 修正、8/28 の PR #18 はこの扱い。
