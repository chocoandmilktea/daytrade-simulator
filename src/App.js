...
function StockCard(p){
  ...
  return(
    <div style={{background:"#050e1c",border:"1px solid "+borderColor,borderRadius:10,padding:"10px 10px",display:"flex",flexDirection:"column",gap:7,cursor:"pointer"}} onClick={function(e){
      var t=e.target;
